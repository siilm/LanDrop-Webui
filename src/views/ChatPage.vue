    ...
    <Teleport to="body">
      ...
      >
        <template v-if="contextMsgIsUploading">
          ...
          >
            <SvgIcon name="block" :size="16" inline /> 取消上传
          </div>
        </template>
        <template v-else>
          <!-- 回复 — 所有消息可用 -->
          ...
          >
            <SvgIcon name="reply" :size="16" inline /> 回复
          </div>
          <!-- 编辑 — 仅自己的消息 -->
          <div
          ...
          >
            <SvgIcon name="edit" :size="16" inline /> 编辑消息
          </div>
          ...
          >
            <SvgIcon name="delete" :size="16" inline /> 撤回
          </div>
          <!-- 本地删除 — 始终可用 -->
          <div
            class="context-menu-item danger"
          ...
          >
            <SvgIcon name="local_delete" :size="16" inline /> 本地删除
          </div>
        </template>
      </div>
    </Teleport>
